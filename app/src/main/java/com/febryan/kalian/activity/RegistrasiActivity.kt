...
class RegistrasiActivity : AppCompatActivity() {
    ...
    private fun daftar() {
        ...
        ApiConfig.instanceRetrofit.regisYuk(name,email,phone,pass,city).enqueue(object :
            ...
            override fun onResponse(call: Call<ResponseUser>, response: Response<ResponseUser>) {
                ...
                if (respon != null){
                    if (respon.status == 0){
                        Toast.makeText(this@RegistrasiActivity, respon.message, Toast.LENGTH_SHORT).show()
                    }else{
            ...
            override fun onFailure(call: Call<ResponseUser>, t: Throwable) {
                pb_regis.visibility = View.GONE
                Toast.makeText(this@RegistrasiActivity, t.message, Toast.LENGTH_SHORT).show()
            }
        })
    }
}